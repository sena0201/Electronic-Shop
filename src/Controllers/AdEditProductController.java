...
/**
 * Servlet implementation class AdEditProductController
 */
@WebServlet("/AdEditProductController")
public class AdEditProductController extends HttpServlet {
     ...
     */
    public AdEditProductController() {
        super();
			...
			List<FileItem> fileItems = upload.parseRequest(request);//Lấy về các đối tượng gửi lên
				...
				for (FileItem fileItem : fileItems) {
					...
					else//Neu la control
					{
						...
						if(tentk.equals("productID"))
							productID = fileItem.getString("utf-8");
				...
				try {
					if(productID != null && productName != null && quantity != null && unitPrice != null && unit != null && categoryID != null && productName != "" && quantity != "" && unitPrice != "" && unit != "" && categoryID != "") {
						...
						int check = productBO.Edit(Long.parseLong(productID),productName, Long.parseLong(quantity), Long.parseLong(unitPrice), unit, photo, Long.parseLong(categoryID));
						if(check > 0) {
